define({ "api": [
  {
    "type": "get",
    "url": "/api/approveall",
    "title": "Approval all reports",
    "name": "ApproveReportAllUsers",
    "group": "Report",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "manager_id",
            "description": "<p>Interval managet id.</p>"
          }
        ]
      }
    },
    "description": "<p>A pproval all users report for the week. For approval from a letter or PDF report. Successful request - closes the tab. Error - &quot;TimeSheets not found&quot;.</p>",
    "version": "0.0.0",
  ...
  },
  {
    ...
    "description": "<p>User report approval for the week. For approval from a letter or PDF report. Successful request - closes the tab. Error - &quot;TimeSheets not found&quot;.</p>",
    "version": "0.0.0",
    "filename": "./app/Http/Controllers/ReportController.php",
    "groupTitle": "Report"
  },
